	...
	<div class="well" style="display:none; background-color: skyblue; position:fixed; top:55px; left:200px; max-width:550px; z-index:2;" id="cart_box">
	...
	<div id="search_area" class="panel panel-default" style="display:none; position:fixed; top:55px; right:620px; height:40px; width:447px; z-index:3;">
	</div>