...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
            <a class="navbar-brand" href="index.php">HomeLine Enterprises</a>
    </div>	
		<ul class=" nav navbar-nav">
			<li id="cartme" style="cursor:pointer">
                <a id="cart_control"><i class="fa fa-shopping-cart fa-fw"></i> My Cart</a>
            </li>
			<li id="your_order"><a href="your_order.php"><span class="fa fa-list-alt"></span> Your Order</a>
			</li>
			
			<li>
				<form class="navbar-form" role="search" method="POST" action="search_result2.php">
					<div class="input-group" id="searchbox" style="width:300px;">
    ...
    <ul class="nav navbar-top-links navbar-right">
		<li id="index"><a href="index.php"><span class="fa fa-shopping-cart fa-fw"></span> Shop</a>
		</li>
		<ul class="nav navbar-top-links navbar-right">
...
<li id="index"><a href="login.php"><span></span>Login</a>
		</li>
		<li id="index"><a href="about.php"><span></span>About Us</a>
		<?php
		}
		...
		?>
			...
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown" href="#">
					<i class="fas fa-align-justify"></i> Categories <i class="fa fa-caret-down"></i>
                </a>
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="#account" data-toggle="modal"><span class="glyphicon glyphicon-user"></span>  My Profile</a></li>
						<li class="divider"></li>
