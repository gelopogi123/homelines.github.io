<!-- Full Details -->
<div class="modal fade" id="admin_detail<?php echo $sqrow['salesid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<table width="100%" cellpadding="5">
					<tr>
						...
						<td width="35%">
							...
							Invoice Date :<?php echo date("F d, Y", strtotime($srow['sales_date'])); ?></strong><br />
